...
class TransformerEngineQuantization(Quantization):
  ...
  def _get_recipe(recipe_name: str):
    ...
    from transformer_engine.common import recipe  # pylint: disable=import-outside-toplevel
  ...
  def _wrap(self, f, name=None):
    ...
    import transformer_engine.jax as te  # pylint: disable=import-outside-toplevel
