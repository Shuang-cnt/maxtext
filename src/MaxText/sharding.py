...
def logical_to_mesh_axes(logical_names: tuple[str, ...], mesh: Mesh, rules: LogicalRules | None = None):
...
def create_sharding(mesh: Mesh, logical_names: tuple[str, ...], rules: LogicalRules | None = None):
